...
public class DatePickerTimeline1 extends LinearLayout {
    private TimelineView timelineView;

    public DatePickerTimeline1(Context context) {
        super(context);
    }

    public DatePickerTimeline1(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public DatePickerTimeline1(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public DatePickerTimeline1(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//        timelineView.setDayTextSize(a.getDimension(R.styleable.DatePickerTimeline_dayTextSize, getResources().getDimension(R.dimen.dayTextSize)));
    ...
    public int getYear() {
        return timelineView.getYear();
    }

    public int getMonth() {
        return timelineView.getMonth();
    }

    public int getDate() {
        return timelineView.getDate();
    }
}
